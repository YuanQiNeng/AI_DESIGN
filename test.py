...
system_message=SystemMessage(content=[{'type':"text",'text':"这是示例的户型json对应的户型图"},{'type':'image','url':"https://ai--design.oss-cn-hangzhou.aliyuncs.com/example1.png"}])
result=agent.invoke({'messages':[system_message,HumanMessage(content="我想设计一个户型,包含一个主卧,一个次卧,一个客厅,一个阳台,一个厨房,主卧包含卫生间与阳台,客厅也有一个阳台.设计的户型面积应该大一些,一道墙体至少有4500mm")]},
